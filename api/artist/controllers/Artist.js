...
/**
 * A set of functions called "actions" for `artist`
 */
...
module.exports = {
  ...
  /**
   * Add an entry to a specific artist.
   *
   * @return {Object}
   */
  ...
  /**
   * Remove a specific entry from a specific artist.
   *
   * @return {Object}
   */
